...
namespace WebReaper.JobProducerFunc
{
    public class WebReaperJobProducer
    {
        private readonly ILogger<WebReaperJobProducer> _logger;

        public WebReaperJobProducer(ILogger<WebReaperJobProducer> log)
        {
            _logger = log;
        }

        [FunctionName("WebReaperJobProducer")]
            ...
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)] HttpRequest req)
        {
            ...
            var jobQueueWriter = new AzureJobQueueWriter(azureSBConnectionString, queue);
